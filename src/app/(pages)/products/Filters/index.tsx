...
const Filters = ({ categories, productColors }: { categories: Category[], productColors: Product[] }) => {
  ...
  const handleCategories = (categoryId: string) => {
    const newCategory = categoryFilters.filter(
      (e) => typeof e !== "object"
    );
  ...
  return (
    <div className="w-full h-fit p-5 mx-2 mt-14 mb-0 md:w-[50vw] md:mt-20 md:mb-0 md:ml-[15rem] lg:mx-0 lg:w-[19vw] lg:mr-[-5vw]">
